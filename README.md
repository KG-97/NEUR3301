...
- a maintainable Exam Lab with 36 mechanism-heavy MCQs, shuffled answer order, block targeting, per-item diagnostics, 29 due-first spaced-retrieval cards and a resolvable error ledger;
