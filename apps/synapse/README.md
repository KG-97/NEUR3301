...
The Exam Lab is a small source-controlled static app. It provides the exact taught-topic numbering (official lecture numbers 1–30 with number 23 correctly treated as a no-class public-holiday slot), 10 mechanism-heavy MCQs, corrected Glia I flashcards, a misconception ledger and portable local progress.
